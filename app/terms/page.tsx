...
export default function TermsPage() {
  return (
    <main><TopNav /><section className="band"><div className="sectionHeader" style={{ maxWidth: 820 }}>
      ...
      <h2>Pilot participation and graduation</h2><p>The current guided pilot is free and is not offered for an indefinite term. Once at least three pilot builders have each closed two or more deals sourced through ADUflow (the &ldquo;graduation trigger&rdquo;), we will give all pilot builders advance notice and a graduation date, after which pilot accounts convert to the founding-builder tier described on the <Link href="/pricing">pricing page</Link>. A builder who does not want to continue on paid terms may opt out and stop using the service any time before the graduation date, with no further obligation. Continued use of the service on or after the graduation date constitutes acceptance of the founding-tier pricing and terms then in effect.</p>
